...
public class Analyze {
	...
	public static void main(String[] args) {
		...
		String[] range2 = {"CHAPTER I. Down the Rabbit-Hole"
				, "              THE END"};
		ta.runSuite("texts/alice-in-wonderland.txt", range2, "'");
		...
		ta.runSuite("texts/pride-prejudice.txt", range5, "\"");
